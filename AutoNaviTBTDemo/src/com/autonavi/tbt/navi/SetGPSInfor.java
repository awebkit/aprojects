...
public class SetGPSInfor extends Thread{
	...
	public void run(){
    	try{
    		FileInputStream fis=new FileInputStream(Environment.getExternalStorageDirectory().getPath() + "/config/VPLog_20120724_111906.txt");
    		 ...
    		 while ((line=br.readLine())!=null) {  
    			 ...
    			 { // valid GPS log
	    	    		...
	    	    		m_tbt.setGPSInfor(1, nmea.m_Longitude, nmea.m_Latitude, nmea.m_Speed, nmea.m_Track,
